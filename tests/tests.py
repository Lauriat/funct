...
class TestArray(unittest.TestCase):
    def test(self):
        ...
        self.assertTrue(Array().lastOption is None)
        ...
        self.assertTrue(gr[0].eq(2).all)
        self.assertTrue(gr[1].eq([1, 3]).all)
        ...
        l.remove_(55)
        self.assertTrue(l.insert(range(2), [99, 98]).equal((99, 98, 1, 2, 3)))
        l.insert_(0, [99, 98])
        self.assertTrue(l.eq((99, 98, 1, 2, 3)).all)
